...
public class AnnotationTypeNLPMID {
	...
	public static final AnnotationTypeNLP<WeightedStringList> MID_ATTRIBUTE = new AnnotationTypeNLP<WeightedStringList>("mid-attr", WeightedStringList.class, Target.DOCUMENT);
}